...
export interface GeekTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "TOKENS_PER_ETH"
...
export interface GeekToken extends BaseContract {
  connect(runner?: ContractRunner | null): GeekToken;
  waitForDeployment(): Promise<this>;

  interface: GeekTokenInterface;
