...
export interface CourseMarketInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "geekToken", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "geekToken", data: BytesLike): Result;
...
export interface CourseMarket extends BaseContract {
  ...
  geekToken: TypedContractMethod<[], [string], "view">;
