          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="cyberpunk-card p-6 rounded-lg relative">
              ...
              <p className="text-gray-400">
                "Web3
                Garden的课程非常实用，讲师都是行业专家，让我在短时间内掌握了智能合约开发技能，现在我已经在一家区块链公司工作了。"
              </p>
            </div>
            ...
            <div className="cyberpunk-card p-6 rounded-lg relative">
              ...
              <p className="text-gray-400">
                "作为一名传统金融从业者，我通过Web3
                Garden的课程顺利转型到了区块链行业。课程内容深入浅出，特别适合想要转行的人。"
              </p>
            </div>
            ...
            <div className="cyberpunk-card p-6 rounded-lg relative">
              ...
              <p className="text-gray-400">
                "Web3
                Garden提供的DeFi课程非常全面，从基础概念到高级策略都有详细讲解。学习体验很好，随时可以与讲师互动提问。"
              </p>
            </div>
          </div>
        </div>
